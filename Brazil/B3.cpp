...
long double dotproduct(pair<long double, long double> a1, pair<long double, long double> a2){
    return a1.first*a2.first + a1.second*a2.second;
}

pair<long double, long double> resta(pair<long double, long double> a1, pair<long double, long double> a2){
    pair<long double, long double> ans;
    ans.first = a1.first - a2.first;
    ans.second = a1.second - a2.second;
    return ans;
}
bool inside(pair<long double, long double> a1, pair<long double, long double> a2, pair<long double, long double> test, char dir){
...
int main(){
    int n;
    long double ax1, ay1, ax2, ay2, bx1, by1, bx2, by2, vx, vy;
    long double th;
    pair< long double, long double> a1, a2, b1, b2, v; 
    cin>>n;
